...
const Gtayo = document.querySelector('#GtayoBtn');

const pass = document.querySelector('#passBtn');

Gtayo.addEventListener('click', () => {

    pass.style.display = 'none';

    Gtayo.style.display = 'none';
    ...
    txt.innerHTML = 'Opps walang bawian ah HAHAHAHAHA <br><br> tra inom inom inom';
